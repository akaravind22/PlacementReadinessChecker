...
const PlacementDriveCard = ({ drive, onDelete, isManage = false, onView }) => {
      ...
      <div>
        <div className="d-flex align-items-center justify-content-between pt-3 border-top border-secondary border-opacity-10">
          ...
          {isManage && onDelete ? (
            ...
            <button type="button" onClick={() => { onView?.(drive); setShowInfo(true); }} className="btn btn-sm btn-outline-brand rounded-3 d-flex align-items-center gap-1"><FaInfoCircle /> Company Info</button>
