...
import { FaUsers, FaBuilding, FaBook, FaChartBar, FaPlusCircle, FaSearch, FaEye, FaQuestionCircle } from 'react-icons/fa';
...
const OfficerDashboard = () => {
  ...
  useEffect(() => {
    const fetchOfficerData = async () => {
      try {
        const [stuRes, drvRes, resRes, repRes, viewRes] = await Promise.all([
